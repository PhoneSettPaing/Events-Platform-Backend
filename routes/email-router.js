    ...
    await resend.emails.send({
      ...
      html: `
        <html>
          ...
          <body style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f9fafb; color: #111827; margin: 0; padding: 40px 0; text-align: center;">
            <table align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 500px; margin: auto; background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.05);">
              <tr>
                <td>
                  <h1 style="color: #4f46e5; font-size: 26px; margin-bottom: 12px;">Booking Confirmed 🎉</h1>
                  <p style="font-size: 16px; color: #374151; line-height: 1.6; margin-bottom: 24px;">
                    Hi <strong>${full_name}</strong>,<br />
                    Thank you for booking your spot! Here are your event details:
                  </p>

                  <table width="100%" cellpadding="0" cellspacing="0" style="text-align: left; font-size: 15px; color: #374151;">
                    <tr>
                  ...
                  <a href="https://eventhub-events.netlify.app" style="display:inline-block; margin-top:28px; padding:14px 28px; background:linear-gradient(135deg, #4f46e5, #6366f1); color:white; border-radius:8px; text-decoration:none; font-weight:600;">View My Booking</a>
